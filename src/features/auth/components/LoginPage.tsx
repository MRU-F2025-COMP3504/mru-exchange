    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-indigo-600 mb-2">MRU Exchange</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                disabled={isLoading}
              />
              <p className="mt-1 text-xs text-gray-500">Must be a valid @mtroyal.ca email</p>
            </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          <p>Only MRU students with @mtroyal.ca email can access this platform</p>
        </div>
      </div>
    </div>
  );
